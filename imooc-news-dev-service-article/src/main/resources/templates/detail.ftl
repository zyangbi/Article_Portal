    ...
    <div class="white-header">
        <div class="white-bar">
            <div class="left-part">
                ...
                <div class="menus">
                    ...
                    <div class="single-default" v-bind:class="{'single-selected': (cat.id==selectedCatId)}"
                        ...
                        <!-- menu-selected -->
                        <a href="javascript:void(0);" class="white-header-left" style="text-decoration:none;"
                           v-bind:class="{'menu-selected': (cat.id==selectedCatId)}" @click="queryByCategory(cat.id)">{{cat.name}}</a>
                    </div>
            ...
            <div class="right-part">
                ...
                <a href="javascript:(0);" @click="goWriterCenter()" target="_blank"
                   class="white-header-right">作家中心</a>
                <a href="javascript:(0);" @click="goAdminCenter()" target="_blank" class="white-header-right"
                   style="margin-right: 20px;">管理平台</a>
            </div>
        </div>
    </div>
